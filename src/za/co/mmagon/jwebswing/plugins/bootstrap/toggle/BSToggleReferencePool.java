 ...
 * @since 20 Apr 2016
 */
public enum BSToggleReferencePool implements ReferencePool
{

    ;
    private BSToggleReferencePool()
    {
    }
    ...
    private BSToggleReferencePool(JavascriptReference javaScriptReference, CSSReference cssReference)
    {
