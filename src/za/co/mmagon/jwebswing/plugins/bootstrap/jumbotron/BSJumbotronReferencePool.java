 ...
 * @since 20 Apr 2016
 */
public enum BSJumbotronReferencePool implements ReferencePool
{
     ...
     */
    private BSJumbotronReferencePool()
    {
    }
     ...
     * @param cssReference
     */
    private BSJumbotronReferencePool(JavascriptReference javaScriptReference, CSSReference cssReference)
    {
