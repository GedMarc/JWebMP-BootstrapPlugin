 ...
 * @since 20 Apr 2016
 */
public enum BSListGroupReferencePool implements ReferencePool
{
     ...
     */
    private BSListGroupReferencePool()
    {
    }
     ...
     * @param cssReference
     */
    private BSListGroupReferencePool(JavascriptReference javaScriptReference, CSSReference cssReference)
    {
