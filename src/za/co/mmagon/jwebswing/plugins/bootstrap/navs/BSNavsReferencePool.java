 ...
 * @since 20 Apr 2016
 */
public enum BSNavsReferencePool implements ReferencePool
{
     ...
     * @param cssReference
     */
    private BSNavsReferencePool(JavascriptReference javaScriptReference, CSSReference cssReference)
    {
