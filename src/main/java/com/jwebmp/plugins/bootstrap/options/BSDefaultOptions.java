		...
		implements IBSComponentOptions
{
	...
	Blockquote_reverse,
	/**
	 * Removes the default list_style and left margin on list items (works on both &lt;ul&gt; and &lt;ol&gt;) This class only applies to immediate children list items (to remove
	 * the default list_style
	...
	List_Inline,
	/**
	 * Lines up the terms and descriptions in the &lt;dl&gt; element side_by_side Starts off like default &lt;dl&gt;s, but when the browser window expands, it will line up
	 * side_by_side
	 */
	Dl_Horizontal,
	/**
