		...
		implements IBSComponentOptions
{
	 ...
	 * Responsive embeds
	 * <p>
	 * Allow browsers to determine video or slideshow dimensions based on the width of their containing block by creating an intrinsic ratio that will properly scale on any
	 * device.
	 * <p>
	 * Rules are directly applied to &lt;iframe&gt;, &lt;embed&gt;, &lt;video&gt;, and &lt;object&gt; elements; optionally use an explicit descendant class .embed-responsive-item
	 * when you want to
