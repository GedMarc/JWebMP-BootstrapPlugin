 ...
 * @author GedMarc
 */
public enum BSComponentListGroupOptions
		implements IBSComponentOptions
{
	 ...
	 * Disabled items
	 * <p>
	 * Add .disabled to a .list-group-item to make it appear disabled. Note that some elements with .disabled will also require custom JavaScript to fully disable their click
	 * events (e.g., links).
	 */
	Disabled,
	;
